        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[var(--border)] bg-[var(--muted)]/30">
              ...
              <th className="text-left px-4 py-3 font-medium text-[var(--muted-foreground)]">Preço/m²</th>
          ...
          <tbody>
            {loading && <tr><td colSpan={5} className="text-center py-12"><div className="h-5 w-5 border-2 border-[var(--primary)] border-t-transparent rounded-full animate-spin mx-auto" /></td></tr>}
            {!loading && tipos.length === 0 && <tr><td colSpan={5} className="text-center py-12 text-[var(--muted-foreground)]">Nenhum tipo cadastrado</td></tr>}
            {!loading && tipos.map((t) => (
              <tr key={t.id} className="border-b border-[var(--border)] last:border-0 hover:bg-[var(--muted)]/30 transition-colors">
                ...
                <td className="px-4 py-3">{formatCurrency(Number(t.preco_m2))}</td>
