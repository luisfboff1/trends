...
// Load JSON (generated by import-pedidos-from-excel.py, next to this script)
const records = JSON.parse(fs.readFileSync(path.join(__dirname, 'pedidos_import.json'), 'utf8'))
